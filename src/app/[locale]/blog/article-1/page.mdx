...
export const article = {
  ...
  description: 'The President has signed a new act amending regulations related to Ukrainian citizens in Poland, with most changes coming into effect on July 1, 2024.',
  author: {
