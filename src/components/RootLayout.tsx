        ...
        <div className="flex items-center gap-x-4">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? "hover:bg-white/10" : "hover:bg-teal-950/10"
            )}
...
function NavigationRow({ children }: { children: React.ReactNode }) {
  return (
    <div className="even:mt-px sm:bg-teal-950">
      <Container>
    ...
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      <header>
        ...
        <motion.div
          ...
          className="relative z-50 overflow-hidden bg-teal-950 pt-2"
          aria-hidden={expanded ? undefined : "true"}
          // @ts-ignore (https://github.com/facebook/react/issues/17157)
          inert={expanded ? undefined : ""}
        >
          <motion.div layout className="bg-neutral-800">
            <div ref={navRef} className="bg-teal-950 pb-16 pt-14">
              <Header
                invert
                panelId={panelId}
                icon={XIcon}
            ...
            <Navigation />
            <div className="relative bg-teal-950 before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-neutral-800">
              <Container>
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full fill-gray-100 stroke-neutral-950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
            yOffset={-96}
            interactive
          />
